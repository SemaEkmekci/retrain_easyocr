...
from test_demo import validation
...
def train(opt, show_number = 2, amp=False):
    ...
    print(f"opt.select_data: {opt.select_data}, type: {type(opt.select_data)}")
    print(f"opt.batch_ratio: {opt.batch_ratio}, type: {type(opt.batch_ratio)}")
